...
const WELL_SUBTITLES = {
  ...
  "MH.12": "ใช้วิธีก่อสร้างแบบจมบ่อพัก (Caisson) — จมบ่อพักครบ E1–E7 (10 ก.ค. 2569) เริ่มงานพื้นบ่อแล้ว (เตรียมเหล็ก 12 ก.ค., ปรับระดับเทลีน 13 ก.ค. — รอรายงานยืนยัน) คาดว่าจะเป็นบ่อสุดท้ายในกลุ่มที่แล้วเสร็จ",
};
